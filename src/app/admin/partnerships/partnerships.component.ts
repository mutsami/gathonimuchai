...
export class PartnershipsComponent implements OnInit { 
  form!: FormGroup;
  partnerships!:any[];
  constructor(private _router: Router,private formBuilder: FormBuilder,private uploadService: CareerFileUploadService,public auth:AuthService,private notifyService : NotificationService) {
